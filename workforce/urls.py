...
urlpatterns = [
    ...
    path('accounts/password-reset/', views.password_reset_with_code, name='password_reset'),
    path('admin/calendar/month-tasks/', views.admin_calendar_month_bulk, name='admin_calendar_month_bulk'),
    ...
    path(
        'admin/task/<int:event_id>/<str:date_key>/',
    ...
    path('admin/workers/<int:pk>/reset-code/', views.admin_worker_reset_code_generate, name='admin_worker_reset_code_generate'),
    path(
        'admin/workers/<int:pk>/export-completed/',
        views.admin_worker_completed_export,
        name='admin_worker_completed_export',
    ),
